    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="bg-gradient-to-r from-red-50 to-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">泳衣配饰</h1>
          <p className="text-lg text-gray-600">专业泳衣配饰产品，为您的泳装系列提供完美搭配</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
          <div className="text-center py-12">
            ...
            <h3 className="mt-4 text-xl font-semibold text-gray-900">泳衣配饰产品展示</h3>
